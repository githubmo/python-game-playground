...
- Use good modern Python standards e.g.:
  ...
  * using [Black](https://github.com/psf/black), [iSort](https://pycqa.github.io/isort/) and [Pyright](https://github.com/microsoft/pyright) to make the code look and feel conformant
